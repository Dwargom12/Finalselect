                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex flex-col items-center justify-center space-y-6">
                        <div class="text-center">
                            <h1 class="text-4xl font-semibold text-indigo-600 dark:text-indigo-400">
                                Welcome, Derick Aton!
                            </h1>
                            <p class="mt-2 text-xl text-gray-600 dark:text-gray-300">
                                {{ __("You're doing great! Let's get to work.") }}
                            </p>
                        </div>
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
    <div class="text-center">
    <img class="rounded-xl sm:w-48 lg:w-60 mx-auto" 
